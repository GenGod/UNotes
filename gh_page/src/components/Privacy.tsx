...
import { Root, MainDiv, Header } from '../styles/Privacy';

const Privacy: React.FunctionComponent = (): JSX.Element => {
  return (
    <Root>
      <MainDiv>
        <Header>UNotes Privacy policy</Header>
        <h4>Privacy Policy</h4>
        <p>
          Bogdan Vetrenko built the UNotes app as a Free app. This SERVICE is
          provided by Bogdan Vetrenko at no cost and is intended for use as is.
          ...
          in this Privacy Policy have the same meanings as in my Terms and
          Conditions, which is accessible at UNotes unless otherwise defined in
          this Privacy Policy.
        </p>
        ...
        <p>
          ...
          cookie is being sent to your device. If you choose to refuse my
        ...
        <p>
          ...
          tasks assigned to them on my behalf. However, they are obligated not
        ...
        <p>
          ...
          me with personal information, I immediately delete this from my
          servers. If you are a parent or guardian and you are aware that ymy
